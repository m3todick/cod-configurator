...
// getConfigurations возвращает только конфигурации указанного пользователя.
// Используется в личном кабинете — каждый пользователь (включая админов) видит только свои.
...
// getAllConfigurations возвращает все конфигурации всех пользователей.
